...
def simulate_user_answers(num_users=10, num_questions=20):
    ...
    for x in range(num_users):
        user_dict[str(uuid.uuid4())] = {"form_data": np.random.randint(
            low=1, high=7, size=(20)).tolist(), "available_to_chat": 1}
...
def generate_survey_paragraph(survey):
    language_scale = {1: "strongly disagree", 2: "disagree", 3: "slightly disagree",
